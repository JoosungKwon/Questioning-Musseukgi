...
import com.kwonjs.questioningmusseukgi.common.dto.ErrorResponse;
...
public class GlobalExceptionHandler {
	...
	public ResponseEntity<ErrorResponse> handleServiceException(HttpServletRequest request, ServiceException e) {
		...
		serviceLog(request, e, errorCode);
	...
	private void serviceLog(HttpServletRequest request, ServiceException e, ErrorCode errorCode) {
